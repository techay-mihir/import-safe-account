...
exports.deployContract = exports.compile = exports.getDelegateCaller = exports.getSafeProxyRuntimeCode = exports.getCompatFallbackHandler = exports.getTokenCallbackHandler = exports.getSafeWithSingleton = exports.getSafeWithOwners = exports.getSafeTemplate = exports.getMock = exports.migrationContractFrom130To141 = exports.migrationContractTo150 = exports.migrationContract = exports.getCreateCall = exports.getMultiSendCallOnly = exports.getMultiSend = exports.getSimulateTxAccessor = exports.getFactoryAt = exports.getFactory = exports.getFactoryContract = exports.getSafeSingletonAt = exports.getSafeSingletonContractFromEnvVariable = exports.getSafeL2SingletonContract = exports.getSafeSingletonContract = exports.getSafeSingleton = exports.compatFallbackHandlerContract = exports.compatFallbackHandlerDeployment = exports.defaultTokenCallbackHandlerContract = exports.defaultTokenCallbackHandlerDeployment = void 0;
...
const getSafeSingletonContractFromEnvVariable = async () => {
    if ((0, config_1.safeContractUnderTest)() === "SafeL2") {
        return await (0, exports.getSafeL2SingletonContract)();
    }
    return await (0, exports.getSafeSingletonContract)();
};
exports.getSafeSingletonContractFromEnvVariable = getSafeSingletonContractFromEnvVariable;
...
const migrationContractTo150 = async () => {
    return await hardhat_1.default.ethers.getContractFactory("Safe150Migration");
};
exports.migrationContractTo150 = migrationContractTo150;
const migrationContractFrom130To141 = async () => {
    return await hardhat_1.default.ethers.getContractFactory("Safe130To141Migration");
};
exports.migrationContractFrom130To141 = migrationContractFrom130To141;
const getMock = async () => {
...
const getSafeTemplate = async (saltNumber = (0, numbers_1.getRandomIntAsString)()) => {
    ...
    const Safe = await (0, exports.getSafeSingletonContractFromEnvVariable)();
...
const getSafeWithSingleton = async (singleton, owners, threshold, fallbackHandler, saltNumber = (0, numbers_1.getRandomIntAsString)()) => {
    const factory = await (0, exports.getFactory)();
    const singletonAddress = await singleton.getAddress();
    const template = await factory.createProxyWithNonce.staticCall(singletonAddress, "0x", saltNumber);
    await factory.createProxyWithNonce(singletonAddress, "0x", saltNumber).then((tx) => tx.wait());
    const safeProxy = singleton.attach(template);
    await safeProxy.setup(owners, threshold || owners.length, constants_1.AddressZero, "0x", fallbackHandler || constants_1.AddressZero, constants_1.AddressZero, 0, constants_1.AddressZero);
    return safeProxy;
};
